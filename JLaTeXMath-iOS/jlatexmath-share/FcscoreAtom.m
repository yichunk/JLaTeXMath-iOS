...
- (OrgScilabForgeJlatexmathBox *)createBoxWithOrgScilabForgeJlatexmathTeXEnvironment:(OrgScilabForgeJlatexmathTeXEnvironment *)env {
  ...
  return new_OrgScilabForgeJlatexmathFcscoreBox_initWithInt_withFloat_withFloat_withFloat_withBoolean_(N_ == 5 ? 4 : N_, factor * 1.0f, factor * 0.07f, factor * 0.125f, N_ == 5);
}
